...
## Load data
cnt <- read.table("G:/Shared drives/RNA Seq Supershedder Project/MALL DE manuscript/all.genes.results.csv", header = TRUE) %>% as_tibble(rownames = NA)
...
covars.I2 <- covars.tib %>% filter(group == "I2")
```
...
colnames(design.I2) <- c("HIGH", "LOW", "MODERATE",
                         "age", "sexM", "weight", "poolMSU2",
                         "poolMSU3", "poolMSU4", "poolMSU5")
