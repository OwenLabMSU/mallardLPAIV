...
```{r eval = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 9, fig.align = "center"}
...
group2 <- group %>% 
  ...
  mutate(group = sub("I015", "I15", group)) %>% 
  mutate(group = sub("I029", "I29", group))
...
```{r eval = FALSE, echo = FALSE, message=FALSE, warning=FALSE, echo=FALSE}
